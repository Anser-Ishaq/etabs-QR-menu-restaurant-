            ...
            <li class="nav-item dropdown">
                <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <?php if(auth()->user()->hasRole('owner')): ?>
                    <div class="media align-items-center">
                        <span class="avatar avatar-sm rounded-circle">
                            <img id="profile-image-nav" alt="..." src="<?php echo e(auth()->user()->restorant?->logowide ?? asset ('images/user.png')); ?>">
                        </span>
                        <div class="media-body ml-2 d-none d-lg-block">
...
<?php /**PATH /home/vagrant/Sites/lara2/resources/views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>