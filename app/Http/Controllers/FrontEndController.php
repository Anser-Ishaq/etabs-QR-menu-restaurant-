...
class FrontEndController extends Controller
{
     ...
     */
    private function filterRestaurantsOnQuery($restaurantIDS): array
    {
        //1. Find all items
    ...
    public function findByLocation(Request $request): View
    {
