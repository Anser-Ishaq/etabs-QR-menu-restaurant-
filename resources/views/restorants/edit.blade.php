    ...
    <div class="container-fluid">
        ...
        <div class="nav-wrapper">
            <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="res_menagment" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link mb-sm-3 mb-md-0" href="{{ route('admin.restaurant.tables.index') }}">
                        <i class="fa fa-table mr-2"></i>{{ __('Table')}}
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link mb-sm-3 mb-md-0 " href="{{ route('items.index') }}">
                        <i class="ni ni ni-collection mr-2"></i>{{ __('Menu')}}
                    </a>
                </li>
                        ...
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    ...
                                    @endif
                                    @if (false&&!config('settings.is_pos_cloud_mode')&&!config('app.issd'))
                                        @if (config('settings.wildcard_domain_ready'))
