<div class="pl-lg-4">
    <form id="restorant-form" method="post" action="<?php echo e(route('admin.restaurants.update', $restorant)); ?>" autocomplete="off"
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <?php if(auth()->user()->hasRole('admin')): ?>
                    ...
                    <div class="row">
                        <div class="col-6 form-group<?php echo e($errors->has('fee') ? ' has-danger' : ''); ?>">
                            ...
                            <input type="number" name="fee" id="input-fee" step="0.01" min="0.00"
                                max="100"
                                class="form-control form-control-alternative<?php echo e($errors->has('fee') ? ' is-invalid' : ''); ?>"
                                value="<?php echo e($restorant->fee); ?>" required autofocus>
                        ...
                        <div class="col-6 form-group<?php echo e($errors->has('static_fee') ? ' has-danger' : ''); ?>">
                            <label class="form-control-label" for="input-description"><?php echo e(__('Tax')); ?></label>
                            <input type="number" name="static_fee" id="input-fee" step="any" min="0"
                                class="form-control form-control-alternative<?php echo e($errors->has('static_fee') ? ' is-invalid' : ''); ?>"
                                value="<?php echo e($restorant->static_fee); ?>" required autofocus>
                ...
                <div class="row">
                    <?php
                    $images = [['name' => 'resto_wide_logo', 'label' => __('Restaurant wide logo'), 'value' => $restorant->logowide, 'style' => 'width: 200px; height: 62px;', 'help' => 'PNG 650x120 recomended'], ['name' => 'resto_wide_logo_dark', 'label' => __('Dark restaurant wide logo'), 'value' => $restorant->logowidedark, 'style' => 'width: 200px; height: 62px;', 'help' => 'PNG 650x120 recomended'], ['name' => 'resto_logo', 'label' => __('Restaurant Image'), 'value' => $restorant->logom, 'style' => 'width: 295px; height: 200px;', 'help' => 'JPEG 590 x 400 recomended'], ['name' => 'resto_cover', 'label' => __('Restaurant Cover Image'), 'value' => $restorant->coverm, 'style' => 'width: 200px; height: 100px;', 'help' => 'JPEG 2000 x 1000 recomended']];
                    if (config('app.issd')) {
                        unset($images[0]);
                        unset($images[1]);
                        unset($images[3]);
...
<?php /**PATH /var/www/html/resources/views/restorants/partials/info.blade.php ENDPATH**/ ?>