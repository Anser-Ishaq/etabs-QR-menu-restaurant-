            ...
            <div class="searchable-container">
                ...
                <div id="totalPrices" v-cloak>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span v-if="itemsCount"><strong><?php echo e(__('Subtotal')); ?>:</strong></span>
                    ...
                    <div v-if="itemsCount" v-cloak>
                        <a href="/cart-checkout" class="btn btn-primary text-white"><?php echo e(__('Checkout')); ?></a>
                    </div>
                    <br/>
                    <div v-if="itemsCount" v-cloak class="text-center mobile-menu">
                        <a type="button" class="btn btn-default btn-block text-white btn-sm" style="text-transform:none" onclick="closeNav()"><?php echo e(__('Continue Shopping')); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /var/www/html/resources/views/layouts/navbars/cartSideMenu.blade.php ENDPATH**/ ?>