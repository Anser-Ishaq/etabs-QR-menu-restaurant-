...
class TablesController extends Controller
{
    ...
    {
        return [
            ['class' => 'col-md-4', 'ftype' => 'input', 'type' => 'number', 'name' => 'Table number', 'id' => 'name', 'placeholder' => 'Enter table number', 'required' => true],
            ['class' => 'col-md-4', 'ftype' => 'input', 'type' => 'number', 'name' => 'Size', 'id' => 'size', 'placeholder' => 'Enter number of chairs', 'required' => true, 'step' => 1],
            ...
            ['class' => 'col-md-4', 'ftype' => 'input', 'name' => 'Waiter Name (optional)', 'id' => 'waiter_name', 'placeholder' => 'Enter Waiter Name', 'required' => true],
        ];
    }
    ...
    public function index()
    {
        ...
        $tables = $this->getRestaurant()
            ->tables()
            ->withCount(['orders' => function ($query) {
                $query->whereIn('payment_status', [PaymentType::PARTIAL_PAID, PaymentType::UNPAID]);
            }])
    ...
    public function edit($id): View
    {
        ...
        $fields[3]['value'] = $item->waiter_name;
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        $item->waiter_name = $request->waiter_name;
        $item->update();
