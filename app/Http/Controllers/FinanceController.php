...
class FinanceController extends Controller
{
    ...
    public function adminFinances()
    {
        ...
        $filteredCards = array_filter($cards, function($card) {
            return !in_array($card['title'], [ 'Net','Processor fee', 'Deliveries', 'Delivery income', 'Platform profit','Total','Platform Fee','Orders']);
        });
    ...
    public function ownerFinances()
    {
        ...
        //CARDS
        $cards = [
            ['title' => 'Orders Processed', 'value' => 0],
            ['title' => 'Total Sales', 'value' => 0, 'isMoney' => true],
            ['title' => 'Platform Fee', 'value' => 0, 'isMoney' => true],
            ['title' => 'PRICE INCL VAT', 'value' => 0, 'isMoney' => true],

            ['title' => 'VAT', 'value' => 0, 'isMoney' => true],
            ['title' => 'Total Tips', 'value' => 0, 'isMoney' => true],
            // ['title' => 'Deliveries', 'value' => 0],
