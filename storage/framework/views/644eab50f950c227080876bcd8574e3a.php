...
<div class="form-group<?php echo e($errors->has($id) ? ' has-danger' : ''); ?>  <?php if(isset($class)): ?> <?php echo e($class); ?> <?php endif; ?>">
   ...
   <div class="custom-control custom-checkbox">
        ...
        <input type="checkbox" class="custom-control-input" name="<?php echo e($id); ?>" id="<?php echo e($id); ?>" value="true"
       <?php if(isset($value) && ($value === 'true' || $value === '1')): ?> checked <?php endif; ?>>
...
<?php /**PATH /var/www/html/resources/views/partials/bool.blade.php ENDPATH**/ ?>