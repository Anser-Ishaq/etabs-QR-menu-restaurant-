<thead class="thead-light">
    <tr>
        ...
        <th class="table-web" scope="col">{{ __('Bill excl VAT') }}</th>
        <th class="table-web" scope="col">{{ __('VAT') }}</th>
        <th class="table-web" scope="col">{{ __('Bill incl VAT') }}</th>
        
        <th class="table-web" scope="col">{{ __('Processor fee') }}</th>
        <th class="table-web" scope="col">{{ __('Tip') }}</th>
        
        <th class="table-web" scope="col">{{ __('Bill Total') }}</th>
