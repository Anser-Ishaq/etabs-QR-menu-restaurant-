<?php $__env->startSection('extrameta'); ?>
    <title>
        <?php echo e($restorant->name); ?></title>
    ...
    <style>
        <?php echo e($restorant->getConfig('custom_menu_css', '')); ?>

    </style>

    <?php echo $restorant->getConfig('custom_menu_js', ''); ?>

<?php $__env->stopSection(); ?>



<?php $__env->startSection('addiitional_button_3'); ?>
    <?php echo $__env->make('restorants.partials.itemsearch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php if(\Akaunting\Module\Facade::has('cards') && $restorant->getConfig('enable_loyalty', false)): ?>
        <li class="web-menu mr-1">
            <a href="<?php echo e(route('loyalty.landing', ['alias' => $restorant->subdomain])); ?>"
                class="btn btn-neutral btn-icon btn-cart" style="cursor:pointer;">
                <span class="btn-inner--icon">
                    <i class="fa fa-id-card-o"></i>
                </span>
                <span class="nav-link-inner--text"><?php echo e(__('loyalty.loyalty_program')); ?></span>
            </a>
        </li>
        <li class="mobile-menu">
            <a href="<?php echo e(route('loyalty.landing', ['alias' => $restorant->subdomain])); ?>" class="nav-link">
                <span class="btn-inner--icon">
                    <i class="fa fa-id-card-o"></i>
                </span>
                <span class="nav-link-inner--text"><?php echo e(__('loyalty.loyalty_program')); ?></span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title white" <?php if ($restorant->description) {
                        ...
                        <h1 class="display-3 text-white notranslate" data-toggle="modal"
                            data-target="#modal-restaurant-info" style="cursor: pointer;"><?php echo e($restorant->name); ?></h1>

                        <p class="display-4" style="margin-top: 120px"><?php echo e($restorant->description); ?></p>
                        <?php echo $__env->make('restorants.partials.social_links', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                        <p><i class="ni ni-watch-time"></i>
                            <?php if(!empty($openingTime)): ?>
                                <span class="closed_time"><?php echo e(__('Opens')); ?> <?php echo e($openingTime); ?></span>
                                <?php endif; ?> <?php if(!empty($closingTime)): ?>
                                    <span class="opened_time"><?php echo e(__('Opened until')); ?> <?php echo e($closingTime); ?></span>
                                    <?php endif; ?> | <?php if(!empty($restorant->address)): ?>
                                        <i class="ni ni-pin-3"></i></i> <a target="_blank"
                                            href="https://www.google.com/maps/search/?api=1&query=<?php echo e(urlencode($restorant->address)); ?>"><span
                                                class="notranslate"><?php echo e($restorant->address); ?></span></a> |
                                        <?php endif; ?> <?php if(!empty($restorant->phone)): ?>
                                            <i class="ni ni-mobile-button"></i> <a
                                                href="tel:<?php echo e($restorant->phone); ?>"><?php echo e($restorant->phone); ?> </a>
                                        <?php endif; ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="title">
                        <h1 class="display-3 text notranslate" data-toggle="modal" data-target="#modal-restaurant-info"
                            style="cursor: pointer;"><?php echo e($restorant->name); ?></h1>
                        ...
                        <p><i class="ni ni-watch-time"></i>
                            <?php if(!empty($openingTime)): ?>
                                ...
                                <?php endif; ?> <?php if(!empty($closingTime)): ?>
                                    ...
                                    <?php endif; ?> <?php if(!empty($restorant->address)): ?>
                                        <i class="ni ni-pin-3"></i></i> <a target="_blank"
                                            href="https://www.google.com/maps/search/?api=1&query=<?php echo e(urlencode($restorant->address)); ?>"><?php echo e($restorant->address); ?></a>
                                        |
                                        <?php endif; ?> <?php if(!empty($restorant->phone)): ?>
                                            <i class="ni ni-mobile-button"></i> <a
                                                href="tel:<?php echo e($restorant->phone); ?>"><?php echo e($restorant->phone); ?> </a>
    ...
    <section class="section pt-lg-0" id="restaurant-content" style="padding-top: 0px">
        ...
        <div class="container container-restorant">
                    ...
                    <ul class="nav nav-pills bg-white mb-2">
                        ...
                        <?php $__currentLoopData = $restorant->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!$category->aitems->isEmpty()): ?>
                                <li class="nav-item nav-item-category"
                                    id="<?php echo e('cat_' . clean(str_replace(' ', '', strtolower($category->name)) . strval($key))); ?>">
                                    <a class="nav-link mb-sm-3 mb-md-0" data-toggle="tab" role="tab"
                                        ...
                                        href="#<?php echo e(clean(str_replace(' ', '', strtolower($category->name)) . strval($key))); ?>"><?php echo e($category->name); ?></a>
            ...
            <?php if(!$restorant->categories->isEmpty()): ?>
                <?php $__currentLoopData = $restorant->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!$category->aitems->isEmpty()): ?>
                        <div id="<?php echo e(clean(str_replace(' ', '', strtolower($category->name)) . strval($key))); ?>"
                            class="<?php echo e(clean(str_replace(' ', '', strtolower($category->name)) . strval($key))); ?>">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                <div class="strip">
                                    <?php if(!empty($item->image)): ?>
                                        <figure>
                                            <a <?php if(!($item->qty_management == 1 && $item->qty < 1)): ?> onClick="setCurrentItem(<?php echo e($item->id); ?>)" <?php endif; ?>
                                                href="javascript:void(0)"><img src="<?php echo e($item->logom); ?>" loading="lazy"
                                                    data-src="<?php echo e(config('global.restorant_details_image')); ?>"
                                                    class="img-fluid lazy" alt=""></a>
                                        </figure>
                                    <?php endif; ?>

                                    <?php if($item->qty_management == 1 && $item->qty < 1): ?>
                                        [<?php echo e(__('Out of stock')); ?>] - <?php echo e($item->name); ?>

                                    <?php else: ?>
                                        <div class="res_title"><b><a onClick="setCurrentItem(<?php echo e($item->id); ?>)"
                                                    href="javascript:void(0)"><?php echo e($item->name); ?></a></b></div>
                                    <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="text-center" style="opacity: 0.2;">
                            <img src="https://www.jing.fm/clipimg/full/256-2560623_juice-clipart-pizza-box-pizza-box.png"
            ...
            <?php if(isset($doWeHaveImpressumApp) && $doWeHaveImpressumApp): ?>
                ...
                <?php if(strlen($restorant->getConfig('impressum_value', '')) > 5): ?>
                    <h3><?php echo e(__(htmlspecialchars($restorant->getConfig('impressum_title', '')))); ?></h3>
                    ...
                    <div class="card bg-secondary shadow border-0">
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            <form role="form" method="post" action="<?php echo e(route('call.waiter')); ?>">
                                ...
                                <?php else: ?>
                                    <input type="hidden" value="<?php echo e($_GET['tid']); ?>" name="table_id" id="table_id" />
                                <?php endif; ?>
    ...
    <?php $__env->startSection('addiitional_button_1'); ?>
        <div class="dropdown web-menu">
            <a href="#" class="btn btn-neutral dropdown-toggle " data-toggle="dropdown"
                ...
                <!--<img src="<?php echo e(asset('images')); ?>/icons/flags/<?php echo e(strtoupper(config('app.locale'))); ?>.png" /> -->
                    ...
                    <?php if($language->language != config('app.locale')): ?>
                        <li>
                            <a class="dropdown-item" href="?lang=<?php echo e($language->language); ?>">
                                <!-- <img src="<?php echo e(asset('images')); ?>/icons/flags/<?php echo e(strtoupper($language->language)); ?>.png" /> -->
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        var PID = "<?php echo e(isset($_GET['pid']) ? $_GET['pid'] : ''); ?>";
    </script>
...
<?php echo $__env->make('layouts.front', ['class' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/restorants/show.blade.php ENDPATH**/ ?>