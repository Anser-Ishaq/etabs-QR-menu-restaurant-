    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.groups.index') }}">
            <i class="ni ni-support-16 text-green"></i> {{ __('Groups') }}
        </a>
    </li>
...
@endif
                ...
                <ul class="nav nav-sm flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('serviceFee.index') }}">
                            <i class="ni ni-settings text-black"></i> {{ __('Service Fee') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('minOrder.index') }}">
                            <i class="ni ni-settings text-black"></i> {{ __('Order minimum price') }}
                        </a>
                    </li>
                    {{-- @if(config('app.isqrsaas'))
                        <li class="nav-item">
        ...
        {{-- @if (!config('settings.hide_admin_support',false))
            <li class="nav-item">
