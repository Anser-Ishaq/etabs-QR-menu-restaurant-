<nav id="navbar-main" class="navbar navbar-top navbar-horizontal navbar-expand-md bg-white navbar-dark">
  ...
  <?php if(config('app.isqrsaas') && config('settings.disable_landing') && !(config('settings.hide_register_when_disabled_landing',false))): ?>
  
  <!-- Big Screen with buttton-->
 <div class="container-fluid px-7 d-none d-lg-flex d-lx-flex">
      <a class="navbar-brand" href="/">
        <img style="height: 35px" src="<?php echo e(config('global.site_logo')); ?>" />
      </a>
  ...
  <?php else: ?>
    ...
    <div class="container-fluid px-7 d-none d-md-none d-lg-block d-lx-block">
      <a class="navbar-brand" href="/">
        <img style="height: 45px" src="<?php echo e(config('global.site_logo')); ?>" />
      </a>
    </div>
...
<?php /**PATH /home/vagrant/Sites/lara2/resources/views/layouts/navbars/navs/guest.blade.php ENDPATH**/ ?>