...
use App\Events\DummyNotification;
...
// Route::get('/otp', [LoginController::class, 'redirectToOtp'])->name('otp');
...
Route::middleware('auth', 'impersonate')->group(function () {
    Route::get('/loading', [LoadingController::class, 'index']);
    ...
    Route::name('admin.')->group(function () {
        ...
        Route::resource('googleReview', GoogleReviewController::class)->only(['index', 'store']);
    ...
    Route::get('/service-fee', [SettingsController::class, 'serviceFeeIndex'])->name('serviceFee.index');
    Route::put('/service-fee/store', [SettingsController::class, 'serviceFeeStore'])->name('serviceFee.store');
    Route::get('/min-order-price', [SettingsController::class, 'minOrderIndex'])->name('minOrder.index');
    Route::put('/min-order-price/store', [SettingsController::class, 'minOrderStore'])->name('minOrder.store');
...
Route::get('/send-notification', function () {
    event(new DummyNotification('This is a test notification!'));
