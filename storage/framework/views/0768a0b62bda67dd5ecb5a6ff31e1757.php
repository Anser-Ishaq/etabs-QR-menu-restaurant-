<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid mt--7">
        <?php echo $__env->yieldContent('customheading'); ?>
        <div class="row">
            <div class="col">
                <div class="card shadow">
                        ...
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <div class="col-4 text-right">
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($action_link3)): ?> 
                                            <a href="<?php echo e($action_link3); ?>" class="btn btn-sm btn-primary"><?php echo e(__($action_name3)); ?></a>
                                    <?php endif; ?>
                                    <?php if(isset($action_link4)): ?> 
                                            <a href="<?php echo e($action_link4); ?>" class="btn btn-sm btn-primary"><?php echo e(__($action_name4)); ?></a>
                                    <?php endif; ?>
                   ...
                   <?php else: ?>
                    ...
                    <div class="card-footer py-4">
                        ...
                        <?php else: ?>
                            <h4><?php echo e(__('crud.no_items',['items'=>__($item_names)])); ?></h4>
                        <?php endif; ?>
                    </div>
                   <?php endif; ?>
...
<?php echo $__env->make('layouts.app', ['title' => __($title)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/general/index.blade.php ENDPATH**/ ?>