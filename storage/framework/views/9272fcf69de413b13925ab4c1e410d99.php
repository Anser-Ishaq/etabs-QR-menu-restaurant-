                            ...
                            <form role="form" method="post" action="<?php echo e(route('extras.store', $item)); ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="variantsSelector[]" multiple="multiple" class="form-control noselecttwo"  id="variantsSelector">
                                        <?php $__currentLoopData = $item->uservariants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="container-fluid mt--7">
        <div class="row">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 text-right">
                                <?php if(auth()->user()->hasRole('owner')): ?>
                                    ...
                                    <a onclick="copyToClipboard('<?php echo e($restorant->getLinkAttribute().'?pid='.$item->id); ?>')" href="#" class="btn btn-sm btn-primary"><?php echo e(__('Copy URL')); ?></a>
                                ...
                                <?php endif; ?>
                                <?php if(route::has('cloner.cloneitem')): ?>
                                    <a href="<?php echo e(route('cloner.cloneitem',$item->id )); ?>" class="btn btn-sm btn-secondary"><?php echo e(__('Clone it')); ?></a>
                               <?php endif; ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <form method="post" action="<?php echo e(route('items.update', $item)); ?>" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php echo $__env->make('partials.select', ['name'=>"Category",'id'=>"category_id",'placeholder'=>"Select category",'data'=>$categories,'required'=>true, 'value'=>$item->category_id], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        ...
                                        <?php echo $__env->make('partials.input',['id'=>'discounted_price','name'=>__('Discounted price'),'placeholder'=>__('0'),'value'=>$item->discounted_price,'required'=>false,'type'=>'number'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                                        <?php if($restorant->getConfig('hide_tax_input',"false")!="false"): ?>
                                            <!-- Hidden -->
                                            <?php echo $__env->make('partials.input',['id'=>'vat','name'=>__('VAT percentage( calculated into item price )'),'placeholder'=>__('Item VAT percentage'),'value'=>$item->vat==""?$restorant->getConfig('default_tax_value',0):$item->vat,'required'=>false,'type'=>'hidden'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php else: ?>
                                            <?php echo $__env->make('partials.input',['id'=>'vat','name'=>__('VAT percentage( calculated into item price )'),'placeholder'=>__('Item VAT percentage'),'value'=>$item->vat==""?$restorant->getConfig('default_tax_value',0):$item->vat,'required'=>false,'type'=>'number'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php endif; ?>
                                        ...
                                        <?php if($item->has_variants==1): ?>
                                            <?php echo $__env->make('partials.toggle',['additionalInfo'=>'Missing variants will have the same price as the item','id'=>'enable_system_variants','name'=>'Enable System Variants','checked'=>($item->enable_system_variants==1)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php endif; ?>
                                        <?php if($restorant->getConfig('stock_enabled',"false")!="false"): ?>
                                            <?php echo $__env->make('partials.toggle',['id'=>'qty_management','name'=>'Enable QTY Managment','checked'=>($item->qty_management==1)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                                            <?php if($item->qty_management==1): ?>
                                                <?php if($item->has_variants==1): ?>
                                                    <?php echo $__env->make('partials.input',['readonly'=>true,'id'=>'qty','name'=>__('Item QTY - determined as sum of the QTY of the variants'),'placeholder'=>__('Item QTY'),'value'=>$item->qty,'required'=>false,'type'=>'number'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php else: ?>
                                                    <?php echo $__env->make('partials.input',['id'=>'qty','name'=>__('Item QTY'),'placeholder'=>__('Item QTY'),'value'=>$item->qty,'required'=>false,'type'=>'number'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
            ...
            <div class="col-xl-6 mb-6 mb-xl-0">
                    ...
                    <!-- Included views -->
                    <?php $__currentLoopData = $extraViews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extraView): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make($extraView['route'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script type="text/javascript">
        ...
        function copyToClipboard(url) {
            ...
            navigator.clipboard.writeText(url)
                .then(() => {
                    js.notify('<?php echo e(__("Product URL copied to clipboard")); ?>' , "success");
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/items/edit.blade.php ENDPATH**/ ?>