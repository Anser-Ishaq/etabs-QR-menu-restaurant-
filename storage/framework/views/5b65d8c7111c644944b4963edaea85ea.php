                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="row">
                            ...
                            <div class="col-sm col-md col-lg col-lg" id="modalItemDetailsPart">
                                ...
                                <div id="exrtas-area">
                                    <br />
                                    <label id="theExtrasLabel" class="form-control-label" for="quantity"><?php echo e(__('Extras')); ?></label>
                                ...
                                <?php if(isset($openingTime)&&!empty($openingTime)): ?>
                                        ...
                                        <br />
                                        <span class="text-muted"><?php echo e(__('Pre orders are possible')); ?></span>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <!-- End inform -->
                            </div>
...
<?php /**PATH /home/vagrant/Sites/lara2/resources/views/restorants/partials/modals.blade.php ENDPATH**/ ?>