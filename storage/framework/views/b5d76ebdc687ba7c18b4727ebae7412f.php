                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small><?php echo e(__('Reset Password')); ?></small>
                        </div>
                        <form role="form" method="POST" action="<?php echo e(route('password.update')); ?>">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-warning my-4"><?php echo e(__('Reset Password')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>