...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="row">
                <div class="col-md-12 <?php echo e($class ?? ''); ?>">
                    <h1 style="display:inline" class="display-2 text-white"><?php echo e(__('Live Orders')); ?></h1>
        ...
        <div id="liveorders" class="row">
            <div class="col-xl-6">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <!-- Title -->
                        <h5 class="h3 mb-0"><?php echo e(__('Partially paid')); ?></h5>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <!-- List group -->
                        <ul class="list-group list-group-flush list my--3">
                            <li v-for="item in neworders" class="list-group-item px-0">
                                <?php echo $__env->make('orders.partials.liveitem', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </li>
            ...
            <div class="col-xl-6">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <!-- Title -->
                        <h5 class="h3 mb-0"><?php echo e(__('Fully paid')); ?></h5>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <!-- List group -->
    ...
    <div class="modal fade modal-xl" id="modal-default" tabindex="-1" role="dialog" aria-labelledby="modal-default"
        aria-hidden="true">
                                    ...
                                    <div class="timeline timeline-one-side" data-timeline-content="axis"
                                        ...
                                        <div class="timeline-block">
                                            ...
                                            <div class="timeline-content">
                                                <div class="d-flex justify-content-between pt-1">
                                                    <div>
                                                        <span class="text-muted text-sm font-weight-bold">Order
                                                            received</span>
                                                    </div>
                                                    <div class="text-right">
                                                        <small class="text-muted"><i class="fas fa-clock mr-1"></i>2 hrs
                                                            ago</small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="timeline-block">
                                            ...
                                            <div class="timeline-content">
                                                <div class="d-flex justify-content-between pt-1">
                                                    <div>
                                                        <span class="text-muted text-sm font-weight-bold">Order Accepted by
                                                            Admin</span>
                                                    </div>
                                                    <div class="text-right">
                                                        <small class="text-muted"><i class="fas fa-clock mr-1"></i>3 hrs
                                                            ago</small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="timeline-block">
                                            ...
                                            <div class="timeline-content">
                                                <div class="d-flex justify-content-between pt-1">
                                                    ...
                                                    <div class="text-right">
                                                        <small class="text-muted"><i class="fas fa-clock mr-1"></i>5 hrs
                                                            ago</small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="timeline-block">
                                            ...
                                            <div class="timeline-content">
                                                <div class="d-flex justify-content-between pt-1">
                                                    <div>
                                                        <span class="text-muted text-sm font-weight-bold">Addmin assigns
                                                            Driver</span>
                                                    </div>
                                                    <div class="text-right">
                                                        <small class="text-muted"><i class="fas fa-clock mr-1"></i>5 hrs
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/orders/live.blade.php ENDPATH**/ ?>