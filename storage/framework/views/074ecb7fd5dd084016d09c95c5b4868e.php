            ...
            <div class="col-lg-5 col-md-7">
                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <?php if((config('app.isft')|| isset($_GET['showCreate']))&&(strlen(config('settings.google_client_id'))>3||strlen(config('settings.facebook_client_id'))>3)): ?>
                        ...
                        <form id="loginForm" role="form" method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-warning my-4"><?php echo e(__('Sign in')); ?></button>
                            </div>

                            <?php if(config('app.isft') || isset($_GET['showCreate'])): ?>
                                <div class="text-center">
                                    <hr />
                    ...
                    <div class="col-6">
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-light">
                                <small class="text-dark"><?php echo e(__('Forgot password?')); ?></small>
                            </a>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.app', ['class' => 'bg'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Sites/lara2/resources/views/auth/login.blade.php ENDPATH**/ ?>