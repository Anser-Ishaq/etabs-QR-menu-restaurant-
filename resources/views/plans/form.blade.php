...
@include('partials.input',['type'=>'number','name'=>'Processing Fee','id'=>"processing_fee",'placeholder'=>"Enter Processing Fee",'required'=>true,'value'=>(isset($plan)?$plan->processing_fee:null)])
@include('partials.input',['type'=>'number','name'=>'Monthly Subscription','id'=>"monthly_subscription",'placeholder'=>"Monthly Subscription",'required'=>true,'value'=>(isset($plan)?$plan->monthly_fee:null)])
