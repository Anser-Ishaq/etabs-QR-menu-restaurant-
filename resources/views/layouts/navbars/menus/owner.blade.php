<ul class="navbar-nav">
    @if(config('settings.makePureSaaS',false))
        <li class="nav-item">
            <a class="nav-link" href="{{ route('home') }}">
                <i class="ni ni-tv-2 text-primary"></i> {{ __('Analytics') }}
            </a>
        </li>
    @endif
        ...
        @if(!config('app.issd'))
            <li class="nav-item">
                <a class="nav-link" href="{{ route('orders.index') }}">
                    <i class="ni ni-basket text-orangse"></i> {{ __('Orders History') }}
                </a>
            </li>
        @endif
    @endif
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.restaurants.edit',  auth()->user()->restorant->id) }}">
            <i class="ni ni-shop text-info"></i> {{ __('Restaurant Management') }}
        </a>
    </li>
    ...
    @if(!config('app.issd')&&!config('settings.makePureSaaS',false))
        <li class="nav-item">
            <a class="nav-link" href="{{ route('items.index') }}">
                <i class="ni ni-collection text-pink"></i> {{ __('Menu Management') }}
            </a>
        </li>
    @endif
    @if(config('app.isft'))
    ...
    @endif
        ...
        {{-- <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.owner.apps') }}">
                <i class="ni ni-app text-red"></i> {{ __('Appss') }}
            </a>
        </li> --}}
    ...
    @endif --}}
    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.googleReview.index') }}">
            <i class="ni ni-send text-green"></i> {{ __('Google Reviews') }}
        </a>
    </li>
