        ...
        <div class="card bg-secondary shadow">
            ...
            @else
                ...
                <div class="card-body">
                    ...
                    <p>{{ __('Processing Fee: ')." ".$planAttribute['plan']['processing_fee']." ".__('% fee charged to restaurant per transaction
                        Monthly subscription:')." ".$planAttribute['plan']['monthly_fee'] }}</p>
                </div>
                ...
                @if(!$showLinkToPlans)
                    ...
                    @endif
                @else
                    <div class="card-footer py-4 align-right right">
