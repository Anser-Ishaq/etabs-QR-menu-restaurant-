        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('owner') || auth()->user()->hasRole('client')): ?>
                        <div class="card">
                            <!-- Card header -->
                    ...
                    <form role="form" method="GET" id="form-time-to-prepare" action="">
                        <div class="form-group">
                            ...
                            <?php for($i=5; $i<=150; $i+=5): ?>
                                <button type="button" value="<?php echo e($i); ?>" class="btn btn-outline-primary btn-time-to-prepare"><?php echo e($i); ?></button>
                            <?php endfor; ?>
                        </div>
                        <div class="text-center">
...
<div class="modal fade" id="modal-order-item-count" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
    <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="modal-title-new-item"><?php echo e(__('Quantity')); ?></h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body p-0">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                    <form role="form" method="POST" id="form-set_qty" action="<?php echo e(route('orders.update',['order'=>isset($order)?$order->id:1])); ?>">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
                        <div class="form-group">
                            <label class="form-control-label" for="item_qty"><?php echo e(__('Quantity')); ?></label>
...
<?php /**PATH /var/www/html/resources/views/orders/partials/modals.blade.php ENDPATH**/ ?>