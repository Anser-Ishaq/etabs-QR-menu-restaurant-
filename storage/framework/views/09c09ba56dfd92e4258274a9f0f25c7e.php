    ...
    <div class="container-fluid">
        ...
        <div class="nav-wrapper">
            <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="res_menagment" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link mb-sm-3 mb-md-0" href="<?php echo e(route('admin.restaurant.tables.index')); ?>">
                        <i class="fa fa-table mr-2"></i><?php echo e(__('Table')); ?>

                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link mb-sm-3 mb-md-0 " href="<?php echo e(route('items.index')); ?>">
                        <i class="ni ni ni-collection mr-2"></i><?php echo e(__('Menu')); ?>
                ...
                <div class="tab-pane fade show active" id="menagment" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                    <div class="card bg-secondary shadow">
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    ...
                                    <?php endif; ?>
                                    <?php if(false&&!config('settings.is_pos_cloud_mode')&&!config('app.issd')): ?>
                                        <?php if(config('settings.wildcard_domain_ready')): ?>
                        ...
                        <div class="card-body">
                            ...
                            <?php if(auth()->user()->hasAnyRole(['admin','owner'])): ?>
                                <?php $__currentLoopData = $vendorModules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendorModule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <hr />
                                    <?php echo $__env->make($vendorModule.'::card', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/restorants/edit.blade.php ENDPATH**/ ?>