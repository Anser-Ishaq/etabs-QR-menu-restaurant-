                                                ...
                                                ->mapWithKeys(fn ($value) => [$value => collect()]);
                                                    ...
                                                    foreach ($allRes as $key => $res) {
                                                        ...
                                                        if (isset($groupedOptions[$group])) {
                                                            ...
                                                            $groupedOptions['Individual']->push($option);
                                                        }
                                                    }
                                                ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Restaurants')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/restorants/index.blade.php ENDPATH**/ ?>