                                ...
                                <div class="col-auto">
                                    <div class="row">
                                        <script>
                                         ...
                                         <button class="btn btn-icon btn-1 btn-sm btn-warning" type="button" id="uploadPdfButton" title="<?php echo e(__('Upload Pdf')); ?>">
                                            Upload PDF
                                        </button>
                                        <input type="file" id="pdfInput" class="d-none" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', ['title' => __('Restaurant Menu Management')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/items/index.blade.php ENDPATH**/ ?>